...
function submitOrderSearchForm( event ){
	...
	var emptyResponse = '<h1>К сожалению, такого номера квитанции не существует!</h1><br /><br />Номер квитанции находиться на самой квитанции!)';
	var emptyTable = '<h1>Результат:</h1><table id="searchFormDivTable" border="0" class="ipod"><tr class="zags"><td>Номер квитанции:</td><td>Устройство:</td><td>Ремонт:</td><td>Статус:</td></tr>';
